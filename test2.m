...
% Last Modified by GUIDE v2.5 01-Apr-2013 19:32:02
...
if (get(hObject,'Value') == get(hObject,'Max'))
    blksize=str2double(get(handles.radiobutton3,'String'));
end
...
if (get(hObject,'Value') == get(hObject,'Max'))
    blksize=str2double(get(handles.radiobutton4,'String'));
end
...
img=imread(dir);
th=str2double(get(handles.edit5,'String'));
nbit=str2double(get(handles.edit4,'String'));

[Cimg,PSNR,CR]=main(th,nbit,blksize,img);
[Cimg,psnrRGB,crRGB]=test2main(th,nbit,blksize,img);

set(handles.edit11,'String',num2str(PSNR));
set(handles.edit10,'String',num2str(CR));
set(handles.edit9,'String',num2str(24/CR));
%%%
set(handles.edit8,'String',num2str(psnrRGB));
set(handles.edit7,'String',num2str(crRGB));
set(handles.edit6,'String',num2str(24/crRGB));
