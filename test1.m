...
% Last Modified by GUIDE v2.5 01-Apr-2013 12:07:58
...
if (get(hObject,'Value') == get(hObject,'Max'))
    blksize=str2double(get(handles.radiobutton1,'String'));
end
...
if (get(hObject,'Value') == get(hObject,'Max'))
    blksize=str2double(get(handles.radiobutton2,'String'));
end
...
img=imread(dir);
th=str2double(get(handles.edit9,'String'));
nbit=str2double(get(handles.edit8,'String'));
[psnrZ,crZ]=test1main(th,nbit,blksize,img);
[Cimg,PSNR,CR]=main(th,nbit,blksize,img);
set(handles.edit2,'String',num2str(PSNR));
set(handles.edit3,'String',num2str(CR));
set(handles.edit4,'String',num2str(24/CR));
%%%
set(handles.edit5,'String',num2str(psnrZ));
set(handles.edit6,'String',num2str(crZ));
set(handles.edit7,'String',num2str(24/crZ));
